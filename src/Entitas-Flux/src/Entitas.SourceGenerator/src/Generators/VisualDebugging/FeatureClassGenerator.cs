...
{
    public class FeatureClassGenerator : AbstractGenerator
    {
        public override string Name => "Feature Class";
...
";
        ...
        public override CodeGenFile[] Generate(CodeGeneratorData[] data) => new[]
        {
            new CodeGenFile(
                "Feature.cs",
                FEATURE_TEMPLATE,
