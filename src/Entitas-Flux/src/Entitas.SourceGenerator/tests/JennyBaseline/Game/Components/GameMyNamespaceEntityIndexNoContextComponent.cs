...
public partial class GameEntity {
    ...
    public GameEntity AddMyNamespaceEntityIndexNoContext(string newValue) {
        var index = GameComponentsLookup.MyNamespaceEntityIndexNoContext;
        var componentPool = GetComponentPool(index);
        var component = componentPool.Count > 0
            ? (My.Namespace.EntityIndexNoContextComponent)componentPool.Pop()
            : new My.Namespace.EntityIndexNoContextComponent();
    ...
    public GameEntity ReplaceMyNamespaceEntityIndexNoContext(string newValue) {
        var index = GameComponentsLookup.MyNamespaceEntityIndexNoContext;
        var componentPool = GetComponentPool(index);
        var component = componentPool.Count > 0
            ? (My.Namespace.EntityIndexNoContextComponent)componentPool.Pop()
    ...
    public GameEntity RemoveMyNamespaceEntityIndexNoContext() {
    ...
    public GameEntity SafeRemoveMyNamespaceEntityIndexNoContext() {
        if (hasMyNamespaceEntityIndexNoContext) 
        {
            RemoveComponent(GameComponentsLookup.MyNamespaceEntityIndexNoContext);
        }
