...
public partial class TestContext {
    ...
    Entitas.IGroup<TestEntity> _myNamespaceUniqueMyNamespaceGroup;

    public TestEntity myNamespaceUniqueMyNamespaceEntity { get { return (_myNamespaceUniqueMyNamespaceGroup ?? (_myNamespaceUniqueMyNamespaceGroup = GetGroup(TestMatcher.MyNamespaceUniqueMyNamespace))).GetSingleEntity(); } }
...
public partial class TestEntity {
    ...
    public TestEntity AddMyNamespaceUniqueMyNamespace(string newValue) {
        var index = TestComponentsLookup.MyNamespaceUniqueMyNamespace;
        var componentPool = GetComponentPool(index);
        var component = componentPool.Count > 0
            ? (My.Namespace.UniqueMyNamespaceComponent)componentPool.Pop()
            : new My.Namespace.UniqueMyNamespaceComponent();
    ...
    public TestEntity ReplaceMyNamespaceUniqueMyNamespace(string newValue) {
        var index = TestComponentsLookup.MyNamespaceUniqueMyNamespace;
        var componentPool = GetComponentPool(index);
        var component = componentPool.Count > 0
            ? (My.Namespace.UniqueMyNamespaceComponent)componentPool.Pop()
    ...
    public TestEntity RemoveMyNamespaceUniqueMyNamespace() {
    ...
    public TestEntity SafeRemoveMyNamespaceUniqueMyNamespace() {
        if (hasMyNamespaceUniqueMyNamespace) 
        {
            RemoveComponent(TestComponentsLookup.MyNamespaceUniqueMyNamespace);
        }
