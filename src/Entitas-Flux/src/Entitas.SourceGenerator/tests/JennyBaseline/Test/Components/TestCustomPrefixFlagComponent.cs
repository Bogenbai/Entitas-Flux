...
public partial class TestContext {
    ...
    Entitas.IGroup<TestEntity> _customPrefixFlagGroup;

    public TestEntity customPrefixFlagEntity { get { return (_customPrefixFlagGroup ?? (_customPrefixFlagGroup = GetGroup(TestMatcher.CustomPrefixFlag))).GetSingleEntity(); } }
