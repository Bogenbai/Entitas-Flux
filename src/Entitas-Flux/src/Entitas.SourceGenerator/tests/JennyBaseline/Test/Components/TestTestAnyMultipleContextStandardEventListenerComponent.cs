...
public partial class TestEntity {
    ...
    public TestEntity AddTestAnyMultipleContextStandardEventListener(System.Collections.Generic.List<ITestAnyMultipleContextStandardEventListener> newValue) {
        var index = TestComponentsLookup.TestAnyMultipleContextStandardEventListener;
        var componentPool = GetComponentPool(index);
        var component = componentPool.Count > 0
            ? (TestAnyMultipleContextStandardEventListenerComponent)componentPool.Pop()
            : new TestAnyMultipleContextStandardEventListenerComponent();
    ...
    public TestEntity ReplaceTestAnyMultipleContextStandardEventListener(System.Collections.Generic.List<ITestAnyMultipleContextStandardEventListener> newValue) {
        var index = TestComponentsLookup.TestAnyMultipleContextStandardEventListener;
        var componentPool = GetComponentPool(index);
        var component = componentPool.Count > 0
            ? (TestAnyMultipleContextStandardEventListenerComponent)componentPool.Pop()
    ...
    public TestEntity RemoveTestAnyMultipleContextStandardEventListener() {
    ...
    public TestEntity SafeRemoveTestAnyMultipleContextStandardEventListener() {
        if (hasTestAnyMultipleContextStandardEventListener) 
        {
            RemoveComponent(TestComponentsLookup.TestAnyMultipleContextStandardEventListener);
        }
